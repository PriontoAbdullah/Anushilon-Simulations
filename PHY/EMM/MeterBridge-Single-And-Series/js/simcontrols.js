...
window.onload = function init(){
	...
	variableArray=[gt.gettext('রোধক ব্যবস্থা:'),gt.gettext('জকি অবস্থান (cm):'),gt.gettext('এখানে রোধ নির্বাচন করুন')];
	...
	document.getElementById('ResBoxLbl').innerHTML=gt.gettext("রোধ নির্বাচন করুন");
